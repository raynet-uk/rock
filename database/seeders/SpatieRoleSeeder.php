...
class SpatieRoleSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ── 1. Roles ──────────────────────────────────────────────────────
        foreach (['super-admin', 'admin', 'committee', 'member', 'temporary_guest', 'temporary_admin'] as $role) {
        ...
        $counts = ['super-admin' => 0, 'admin' => 0, 'committee' => 0, 'member' => 0, 'temporary_guest' => 0, 'temporary_admin' => 0];
