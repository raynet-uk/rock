    ...
    <table width="580" style="background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 4px 16px rgba(0,51,102,.1);">
      ...
      <tr><td style="padding:32px 36px;">
        ...
        <p style="font-size:14px;color:#2d4a6b;line-height:1.7;margin:0 0 20px;">
          Your photo has been selected as a <strong>featured photo</strong> and is now displayed on the {{ \App\Helpers\RaynetSetting::groupName() }} homepage.
        </p>
        <a href="{{ url('/gallery') }}" style="display:inline-block;background:#f59e0b;color:#fff;padding:12px 28px;border-radius:999px;font-weight:bold;text-decoration:none;font-size:14px;">View Gallery →</a>
      </td></tr>
