...
<div class="pub-hero">
    <div class="pub-hero-inner">
        ...
        <div class="pub-title">📋 Checkpoint</div>
        <div class="pub-sub">The operational bulletin for RAYNET members — exercises, procedures and technical updates.</div>
    </div>
</div>
        ...
        <div class="current-cover">
            ...
            @else
                <div class="current-cover-placeholder">
                    <div class="icon">📋</div>
                    <div style="font-size:.8rem;color:var(--text-muted);">Checkpoint</div>
                </div>
            @endif
        </div>
